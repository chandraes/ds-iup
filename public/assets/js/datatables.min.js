 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-2.3.1/cr-2.1.0/date-1.5.5/fc-5.0.4/fh-4.0.2/r-3.0.4/rg-1.5.1/rr-1.5.0/sc-2.4.3/sb-1.8.2/sp-2.3.3/sl-3.0.1/sr-1.4.1
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.3.1, ColReorder 2.1.0, DateTime 1.5.5, FixedColumns 5.0.4, FixedHeader 4.0.2, Responsive 3.0.4, RowGroup 1.5.1, RowReorder 1.5.0, Scroller 2.4.3, SearchBuilder 1.8.2, SearchPanes 2.3.3, Select 3.0.1, StateRestore 1.4.1
 */

...
<div class="content-wrapper">
        ...
        <div class="info-left">
            <table class="info-table">
                ...
                {{-- <tr>
                    <td>Tipe Retur</td>
                    <td>:</td>
                    <td>{{$invoice->tipe == 1 ? 'Retur ke Supplier' : 'Retur dari Konsumen'}}</td>
                </tr> --}}
                ...
                {{-- <tr>
                    ...
                    <td style="vertical-align: top;"><strong>{{$invoice->barang_unit->nama}}</strong></td>
                </tr> --}}
                @else
                ...
                {{-- <tr>
                    ...
                    <td style="vertical-align: top;">
                        <strong>{{$invoice->barang_unit?->nama }}</strong>

                        <small style="color: #555;">{{$invoice->konsumen->alamat ?? ''}}</small>
                    </td>
                </tr> --}}
                @endif
            </table>
    ...
    <table class="signature-table">
        <tr>
            ...
            <td style="width: 50%;">
                <p><strong>{{ $invoice->barang_unit?->nama}}</strong></p>
                <div class="signature-space"></div>
                <p class="signature-label">

            ...
            <table class="table">
                <tr class="text-center">
                    ...
                    <td><a href="#" data-bs-toggle="modal" data-bs-target="#modalCreate"><img
                                src="{{asset('images/katalog.svg')}}" alt="add-document" width="30"> Tambah Katalog</a>
                    </td>
                </tr>
            </table>
        </div>
...
<a class="btn btn-primary btn-sm" href="{{ route('katalog.download', $d)}}" target="_blank">Download <i class="ms-2 fa fa-file"></i></a>
                            ...
                            <form action="{{ route('katalog.delete', ['katalog' => $d]) }}" method="post" class="d-inline">
                                @csrf
                                @method('delete')

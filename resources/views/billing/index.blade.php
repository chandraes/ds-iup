    ...
    <div class="row justify-content-left">
        ...
        <div class="col-md-2 text-center mt-5">
            <a href="{{route('billing.form-dividen')}}" class="text-decoration-none">
                ...
                <h5 class="mt-3">FORM DIVIDEN</h5>
            </a>
        </div>
        <div class="col-md-2 text-center mt-5">
            <a href="#" class="text-decoration-none">
                <img src="{{asset('images/kosong.svg')}}" alt="" width="70">
                <h5 class="mt-3">FORM KASBON</h5>
            </a>
        </div>
        <div class="col-md-2 text-center mt-5">
            <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#modalLain">
                ...
                <h5 class="mt-3">FORM LAIN-LAIN</h5>
            </a>
        ...
        <div class="col-md-2 text-center mt-5">
            <a href="#" class="text-decoration-none">
                <img src="{{asset('images/kosong.svg')}}" alt="" width="70">
                <h5 class="mt-3">FORM CSR<br>(TIDAK TERTENTU)</h5>
            </a>
        </div>
    </div>
    <div class="row justify-content-left">
    ...
    <div class="row justify-content-left">
        ...
        <div class="col-md-2 text-center mt-5">
            <a href="{{route('billing.form-cost-operational.cost-operational')}}" class="text-decoration-none">
                ...
                <h5 class="mt-3">FORM OPERATIONAL</h5>
            </a>
        </div>
        <div class="col-md-2 text-center mt-5">
            <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#formKecil">
                ...
                <h5 class="mt-3">FORM KAS KECIL</h5>
            </a>
        ...
        <div class="col-md-2 text-center mt-5">
            <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#modalFormBungaInvestor">
                ...
                <h5 class="mt-3">FORM BUNGA KREDITUR</h5>
            </a>
        </div>
    </div>
    <hr>
    ...
    <div class="row justify-content-left">
        ...
        {{-- <div class="col-md-2 text-center mt-5">
            <a href="{{route('billing.lihat-stok')}}" class="text-decoration-none">
                ...
                <h5 class="mt-3">FORM JUAL</h5>
            </a>
        </div> --}}
        <div class="col-md-2 text-center mt-5">
            <a href="{{route('billing.sales-order')}}" class="text-decoration-none">
                <img src="{{asset('images/order-ppn.svg')}}" alt="" width="70">
                <h5 class="mt-3">SALES ORDER
                    @if ($sales_order_all > 0)
                    <span class="text-danger">({{$sales_order_all}})</span>
                    @endif
                </h5>
            </a>
        </div>
    ...
    <div class="row justify-content-left">
        ...
        <div class="col-md-2 text-center mt-5">
            <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#formReturModal">
                <img src="{{asset('images/retur.svg')}}" alt="" width="70">
        ...
        <div class="col-md-2 text-center mt-5">
            <a href="{{route('billing.barang-retur')}}" class="text-decoration-none">
                ...
                <h5 class="mt-3">TERIMA / KIRIM<br>RETUR
                    @if ($br > 0)
    ...
    <div class="row justify-content-left">
        ...
        <div class="col-md-2 text-center mt-5">
            <a href="{{route('billing.invoice-supplier.non-ppn')}}" class="text-decoration-none">
                ...
                <h5 class="mt-3">INVOICE SUPPLIER<br>NON PPN
                    @if ($isn > 0)
        ...
        <div class="col-md-2 text-center mt-5">
            ...
            <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#modalKonsumenPpn">
                ...
                <h5 class="mt-3">INVOICE KONSUMEN<br>PPN
                    @if ($ik > 0)
        ...
        <div class="col-md-2 text-center mt-5">
            ...
            <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#modalKonsumenNonPpn">
                ...
                <h5 class="mt-3">INVOICE KONSUMEN<br>NON PPN
                    @if ($ikn > 0)
        ...
        <div class="col-md-2 text-center mt-5">
            ...
            <a href="{{route('billing.invoice-konsumen.all')}}" class="text-decoration-none">
                ...
                <h5 class="mt-3">INVOICE KONSUMEN ALL
                    {{-- @if ($ikn > 0)
                    <span class="text-danger">({{$ikn}})</span>
                    @endif --}}
                </h5>

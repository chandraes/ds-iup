        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="keranjangTitle">
                    <i class="bi bi-pencil-square me-2"></i> Input Jumlah Beli
                </h5>
            ...
            <div class="modal-body">
                <form method="post" id="keranjangForm" action="{{route('billing.form-beli.detail.store', $b->id)}}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            <div class="alert alert-info d-flex justify-content-between align-items-center mb-0"
                                ...
                                <span id="stok_tersedia" class="badge bg-primary rounded-pill"
                                    style="font-size: 1.05rem;">0</span>
                            </div>
                        </div>

...
<div class="container table-responsive ml-3">
    ...
    <div class="row mt-3">
        <table class="table table-hover table-bordered" id="rekapTable">
            ...
            <tfoot>
                {{-- <tr>
                    <th style="text-align: right" colspan="{{$data->kas_ppn ? '8' : '7'}}">Total DPP : </th>
                    <th style="text-align: right">{{$data->dpp}}</th>
                </tr>
                <tr>
                    <th style="text-align: right" colspan="{{$data->kas_ppn ? '8' : '7'}}">Diskon : </th>
                    <th style="text-align: right">{{number_format($data->diskon, 0 ,',', '.')}}</th>
                </tr>
                <tr>
                    <th style="text-align: right" colspan="{{$data->kas_ppn ? '8' : '7'}}">DPP Setelah Diskon : </th>
                    <th style="text-align: right">{{number_format($data->total-$data->diskon, 0 ,',', '.')}}</th>
                </tr>
                <tr>
                    <th style="text-align: right" colspan="{{$data->kas_ppn ? '8' : '7'}}">Ppn : </th>
                    <th style="text-align: right">{{$data->nf_ppn}}</th>
                </tr>
                <tr>
                    <th style="text-align: right" colspan="{{$data->kas_ppn ? '8' : '7'}}">Penyesuaian : </th>

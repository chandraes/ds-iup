                    ...
                    <td class="text-center align-middle">
                        @if ($keranjang->where('barang_stok_harga_id', $stokHarga->id)->first())
                           <button type="text" class="form-control text-center" onclick="setModalJumlah({{$stokHarga}}, {{$stokHarga->id}},
                                    ...
                                    {{$keranjang->where('barang_stok_harga_id', $stokHarga->id)->first()->id}})" data-bs-toggle="modal" data-bs-target="#keranjangModal">{{$keranjang->where('barang_stok_harga_id', $stokHarga->id)->first()->qty}}</button>
                        @else

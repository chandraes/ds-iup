        ...
        <div class="col-md-6">
            <form action="{{route('pajak.ppn-keluaran.keranjang-lanjut')}}" method="post" id="lanjutForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control text-end" name="penyesuaian" id="penyesuaian"
                            value="0" required onkeyup="checkPenyesuaian()"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-7 pt-2 text-end">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control text-end" name="ppn_keluaran_total" id="ppn_keluaran_total"
                            value="{{number_format($data->where('dipungut', 1)->sum('nominal'), 0, ',', '.')}}"
                            disabled />
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control text-end" name="ppn_keluaran_plus_penyesuaian" id="ppn_keluaran_plus_penyesuaian"

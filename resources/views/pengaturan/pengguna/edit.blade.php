                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <input type="password" class="form-control" id="password-{{ $d->id }}" name="password" placeholder="Password">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <select class="form-select" name="barang_unit_id" id="barang_unit_id" required>
                                ...
                                <option value="{{ $p->id }}" @if ($p->id == $d->barang_unit_id) selected @endif>{{ Str::upper($p->nama) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>

        ...
        <div class="col-md-7">
            <table class="table">
                <tr class="text-center">
                    ...
                    <td><a href="{{route('sales.pre-order')}}"><img src="{{asset('images/back.svg')}}" alt="dashboard"
...
<div class="container-fluid table-responsive ml-3">
    ...
    <div class="row mt-3">
        <form action="{{route('sales.pre-order.update', ['preorder' => $order->id])}}" method="post" id="storeForm">
            @csrf
            <div class="row px-5">
    ...
    function indenDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{route('sales.pre-order.detail.delete', ['orderDetail' => ':id'])}}'.replace(':id', id),
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },

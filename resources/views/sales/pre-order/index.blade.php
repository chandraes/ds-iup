                ...
                <tr>
                    ...
                    <td class="text-end align-middle text-nowrap">
                        <div class="row px-3 pb-2">
                            <a href="{{route('sales.pre-order.detail', ['preorder' => $d->id])}}" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-file me-1"></i> Detail</a>
                        </div>
                        <div class="row px-3">
    ...
    function voidOrder(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{route('sales.pre-order.void', ['preorder' => ':id'])}}'.replace(':id', id),
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },

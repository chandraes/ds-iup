...
@include('db.diskon-umum.edit')
<div class="container mt-5 table-responsive">
    <table class="table table-bordered table-hover" id="data">
        <thead class="table-warning bg-gradient">
            <tr>
                <th class="text-center align-middle" style="width: 5%">NO</th>
                <th class="text-center align-middle">UNTUK PEMBAYARAN</th>
...
<script>
    ...
    function editRekening(data, id) {
        ...
        document.getElementById('editForm').action = '/db/diskon-umum/update/' + id;
    };

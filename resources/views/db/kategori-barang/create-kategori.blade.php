    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="creat-category-title">Tambah Kategori</h5>
            ...
            <div class="modal-body">
                <table class="table table-responsive table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form action="{{route('db.barang.kategori.update', $j->id)}}" method="post"
                                id="updateJabatan">
                                @csrf
                                @method('patch')
                            ...
                            <form action="{{route('db.barang.kategori.delete', $j)}}" method="post"
                                class="d-inline">
                                @csrf
                                @method('delete')
                ...
                <form action="{{route('db.barang.kategori.store')}}" method="post">
                    @csrf

    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="creat-category-title">Tambah Kategori Perusahaan</h5>
            ...
            <div class="modal-body">
                <table class="table table-responsive table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form action="{{route('db.unit.update', $j->id)}}" method="post"
                                id="updateJabatan">
                                @csrf
                                @method('patch')
                            ...
                            <form action="{{route('db.unit.delete', $j)}}" method="post"
                                class="d-inline">
                                @csrf
                                @method('delete')
                ...
                <form action="{{route('db.unit.store')}}" method="post">
                    @csrf
                    <div class="input-group mb-3 mt-3">
                        <input type="text" class="form-control" name="nama" id="nama_jabatan_tambah"
                            aria-describedby="helpId" placeholder="Nama Unit" required>

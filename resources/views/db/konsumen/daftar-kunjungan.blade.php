...
<div class="body-items">
                    ...
                    <table style="width: 100%; font-size: 10px">
                        <tr id="namaTr">
                            ...
                            <td style="vertical-align:top; width: 150px">
                                <strong>{{$konsumen->kode_toko ? $konsumen->kode_toko->kode : ''}}
                                    {{$konsumen->nama}}</strong>
                            </td>
    ...
    <div class="po-items">
        <table class="table-items" style="font-size: 10px">
            <tbody>
                <tr>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">JANUARI</td>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">JULI</td>
                </tr>
                <tr>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">FEBRUARI</td>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">AGUSTUS</td>
                </tr>
                <tr>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">MARET</td>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">SEPTEMBER</td>
                </tr>
                <tr>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">APRIL</td>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">OKTOBER</td>
                </tr>
                <tr>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">MEI</td>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">NOVEMBER</td>
                </tr>
                <tr>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">JUNI</td>
                    <td class="text-left" style="vertical-align: top; height: 110px; font-weight:bolder">DESEMBER</td>
                </tr>
            </tbody>
        </table>
